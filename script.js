...
var newQuoteButton = document.querySelector("#new-quote-btn")
...
function updateQuote() {
  ...
  quoteInfo.innerHTML =  'Season ' + quotes[quoteNumber].season + ', Episode ' + quotes[quoteNumber].episode_no + ': ' + quotes[quoteNumber].episode_name + ' (' + quotes[quoteNumber].airdate + ')';
}
